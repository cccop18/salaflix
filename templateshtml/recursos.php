...
<nav>
    ...
    <a href="#" class="selecionado">Recursos</a>
...
<main>
    ...
    <div class="btnaaaaa">
        <a href="./cadRecurso.php" class="buttonsCad btncad">Cadastrar Novo Recurso</a>
    </div>

    <div id="tabela">
        <?php
        include '../listas/recursos.php';
        ?>
    </div>
</main>
